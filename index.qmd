...
![](static/img/mount_bind.drawio.svg){align="center" width="80%"}
...
![](static/img/mount_volume.drawio.svg){align="center" width="80%"}
...
1. VSCodeで`Rebuild and Reopen in Container`を選択する
1. Rプロジェクトを開き, `renv::restore()` を実行して必要なパッケージをインストールする
